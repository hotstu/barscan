...
package github.hotstu.lib.barscaner.result;
...
import github.hotstu.lib.barscaner.Contents;
import github.hotstu.lib.barscaner.Intents;
...
public abstract class ResultHandler {
  ...
  private String parseCustomSearchURL() {
    ...
    String customProductSearch = prefs.getString(PreferencesConstants.KEY_CUSTOM_PRODUCT_SEARCH,
        null);
